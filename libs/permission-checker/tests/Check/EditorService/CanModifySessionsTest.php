    ...
    public static function provideInvalidPermissionsCheckData(): iterable
    {
        ...
        yield 'token with protected default branch' => [
            ...
            'error' => new PermissionDeniedException(
                'Role "none" is not allowed to modify sessions on protected branch projects',
            ),
        ];
        ...
        yield 'production manager with protected default branch' => [
            ...
            'error' => new PermissionDeniedException(
                'Role "productionManager" is not allowed to modify sessions on protected branch projects',
            ),
        ];
        ...
        yield 'developer with protected default branch' => [
            ...
            'error' => new PermissionDeniedException(
                'Role "developer" is not allowed to modify sessions on protected branch projects',
            ),
        ];
        ...
        yield 'reviewer with protected default branch' => [
            ...
            'error' => new PermissionDeniedException(
                'Role "reviewer" is not allowed to modify sessions on protected branch projects',
            ),
        ];
    }
