...
class DownloadTablesDefaultTest extends AbstractTestCase
{
    ...
    public function testReadTablesDefaultBackend(): void
    {
        ...
        // the timing, size and Storage job detail added by AJDA-3148
        ...
        self::assertTrue($this->testHandler->hasInfoThatContains('2 storage jobs finished in '));
        self::assertTrue($this->testHandler->hasInfoThatContains('Downloading 2 exported tables.'));
        self::assertTrue($this->testHandler->hasInfoThatContains(
        ...
        self::assertTrue($this->testHandler->hasInfoThatContains('Downloaded 2 tables, '));
