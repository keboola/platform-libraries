...
use Keboola\PhpTestUtils\Fixtures\Dynamic\ConfigurationWithMappingAndTables;
use Keboola\PhpTestUtils\TestEnvVarsTrait;
use Keboola\StorageApi\ClientException;
use Keboola\StorageApi\Components;
use PHPUnit\Framework\TestCase;

class ConfigurationWithMappingAndTablesTest extends TestCase
{
    ...
    {
        $fixture = new ConfigurationWithMappingAndTables();
