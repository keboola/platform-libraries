...
/**
 * Migrating a schedule reuses the source schedule's token instead of minting a new one, so unlike
 * {@see CanModifySchedules} it is also allowed for role-less tokens, which is what automated migrations run with.
 */
class CanMigrateSchedules implements PermissionCheckInterface
{
